...
from pip._vendor.packaging.markers import Marker as _Marker

from pip._vendor.dep_logic.markers.any import AnyMarker
from pip._vendor.dep_logic.markers.base import BaseMarker
from pip._vendor.dep_logic.markers.empty import EmptyMarker
from pip._vendor.dep_logic.specifiers import BaseSpecifier
from pip._vendor.dep_logic.specifiers.base import VersionSpecifier
from pip._vendor.dep_logic.specifiers.generic import GenericSpecifier
from pip._vendor.dep_logic.utils import DATACLASS_ARGS, OrderedSet, get_reflect_op

if t.TYPE_CHECKING:
    from pip._vendor.dep_logic.markers.multi import MultiMarker
    from pip._vendor.dep_logic.markers.union import MarkerUnion
...
class MarkerExpression(SingleMarker):
    ...
    def _get_specifier(self) -> BaseSpecifier:
        from pip._vendor.dep_logic.specifiers import parse_version_specifier
