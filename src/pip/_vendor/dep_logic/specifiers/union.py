...
from pip._vendor.dep_logic.specifiers.base import BaseSpecifier, UnparsedVersion, VersionSpecifier
...
from pip._vendor.dep_logic.utils import DATACLASS_ARGS, first_different_index, pad_zeros
