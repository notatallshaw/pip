...
types.  Every fetch goes through a :class:`~nab_provider.fetch_port.FetchPort`,
which nab's own :class:`~nab_project.fetch.FetchCoordinator` implements by
...
from pip._vendor.nab_provider.errors import (
    HttpError,
    MetadataHashMismatchError,
    SdistHashMismatchError,
    WheelHashMismatchError,
)
from pip._vendor.nab_provider.records import DistFile, SdistFile, WheelFile
...
class Provider:
    ...
    :class:`~nab_provider.fetch_port.FetchPort`.  nab's own coordinator
    ...
    def effective_build_policy(
        ...
        (raises :class:`~nab_project.config.OverrideConflictError`).
        """
    ...
    def _effective_field(
        ...
        *,
        ...
        candidate, raises :class:`~nab_project.config.OverrideConflictError`:
    ...
    def _choose_extra_version(
        ...
        """See :func:`nab_provider._provider.extras.choose_extra_version`."""
    ...
    def _record_no_versions_reason(
        ...
        *,
        ...
        The recorded value is a :class:`~nab_provider.diagnostics.NoVersionsReason`,
    ...
    def _capture_lookahead_blockers(self, normalized: str) -> list[Blocker]:
        ...
        Returns one :class:`~nab_provider.diagnostics.Blocker` per blocker
    ...
    def get_no_versions_reason(self, package: str) -> NoVersionsReason | None:
        ...
        :attr:`~nab_provider.diagnostics.NoVersionsReason.kind` and the
    ...
    def _resolve_metadata(
        ...
        """See :func:`nab_provider._provider.metadata_resolver.resolve_metadata`."""
    ...
    def _get_extra_dependencies(
        ...
        """See :func:`nab_provider._provider.extras.get_extra_dependencies`."""
    ...
    def vcs_pin_for(self, canonical_name: str) -> str | None:
        ...
        Written by :func:`~nab_provider._provider.sources.materialize_vcs_source`
