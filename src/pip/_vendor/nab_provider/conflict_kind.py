...
A leaf module that :mod:`nab_project.config`, :mod:`nab_provider.target`, and
:mod:`nab_project._lockfile.disjointness` can import without forming a
cycle.  :class:`nab_project.config.ConflictKind` takes its enum values from
