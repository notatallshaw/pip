...
def message_about_scripts_not_on_PATH(scripts: Sequence[str]) -> str | None:
    ...
    # A resolved script directory that string-equals a PATH entry is on
    # PATH. Resolving PATH entries walks the filesystem, so it is left for
    # directories these cheap checks cannot clear.
